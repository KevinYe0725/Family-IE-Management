alter table assets drop check ck_assets_purchase_value;
alter table assets drop check ck_assets_current_value;
alter table asset_valuations drop check ck_asset_valuations_value;
