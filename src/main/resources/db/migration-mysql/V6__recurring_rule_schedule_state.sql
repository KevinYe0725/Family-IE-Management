...
alter table recurring_rules modify column start_on date not null default (current_date);
alter table recurring_rules drop check ck_recurring_rules_schedule;
