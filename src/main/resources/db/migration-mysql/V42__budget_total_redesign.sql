...
-- MySQL dialect. Mirrors db/migration/V42__budget_total_redesign.sql for H2.
...
alter table budgets drop index uk_budgets_household_period_active_scope;
alter table budgets add column scope_member_key bigint generated always as (coalesce(member_id, -1)) stored;
