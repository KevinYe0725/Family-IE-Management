alter table budgets drop constraint uk_budgets_household_period_scope;
alter table budgets drop constraint ck_budgets_amount;
...
alter table budgets add column scope_target_key bigint generated always as (
    coalesce(category_id, member_id, cast(-1 as bigint))
);
...
alter table budget_revisions drop constraint ck_budget_revisions_old_amount;
alter table budget_revisions drop constraint ck_budget_revisions_new_amount;
...
alter table budget_revisions alter column old_period_month set not null;
alter table budget_revisions alter column new_period_month set not null;
alter table budget_revisions alter column old_scope_type set not null;
alter table budget_revisions alter column new_scope_type set not null;
alter table budget_revisions alter column old_active set not null;
alter table budget_revisions alter column new_active set not null;
