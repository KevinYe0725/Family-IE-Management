...
public class InviteController {
    ...
    @GetMapping("/api/family/invites") ApiEnvelope<List<InviteService.InviteView>> list(Authentication authentication) { return ApiEnvelope.data(invites.list(authentication)); }
