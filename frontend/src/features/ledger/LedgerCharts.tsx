...
export interface LedgerSummary {currency:string;income:string|null;expense:string|null;balance:string|null;transactionCount:number;unconvertedCount:number;categories:CategoryTotal[];daily:DailyTotal[]}
